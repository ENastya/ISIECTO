...
public class UsersController implements Serializable {
    ...
    public String prepareViewLogIn() {
        List<Users> list = ejbFacade.findAll();
        boolean find = false;
        for (Users u: list){
            if (current.getEmail().equals(u.getEmail()) & current.getPassword().equals(u.getPassword())){
            current = u;
            selectedItemIndex = current.getId();
        return "View";
            }
        }
        return null;
